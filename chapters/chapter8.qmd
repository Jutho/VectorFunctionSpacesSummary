...
covered. We have also covered subsections 8.3.1 and 8.3.2. Subsection 8.3.3, 8.4.3, 8.4.4 and section 8.5 have only been covered very briefly, and from subsection 8.3.3 onwards, there will be no theory questions.
...
* Understand how to use a Green's function, and how to construct it in the case of a second order problem with separated boundary conditions (p300 - 301, remark 8.30).
