...
Several sections in the lecture notes contain technical results and their proofs which we did not discuss and are beyond the scope of this course (in particular everything in 7.1, subsections 7.4.2 and 7.4.3, section 7.6.1). The specific classes of orthogonal polynomials (7.3.2 - 7.3.5) where not covered in the theory classes but have been covered as part of the exercises.
